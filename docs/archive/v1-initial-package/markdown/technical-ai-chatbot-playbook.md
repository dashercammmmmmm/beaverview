...
- Scale option: Orion for heavier concurrency or larger models.
...
Orion scale-up option:

- Use if DGX Spark cannot meet latency/concurrency needs.
- Consider for larger context windows, heavier retrieval, or broader rollout.
